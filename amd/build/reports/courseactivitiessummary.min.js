...
define('local_edwiserreports/reports/courseactivitiessummary', [
    ...
    function initializeDatatable() {
        ...
        let statuses = [
            `<span class="warning-tag">${M.util.get_string('notyetstarted', 'local_edwiserreports')}</span>`,
            `<span class="success-tag">${M.util.get_string('completed', 'local_edwiserreports')}</span>`,
            `<span class="danger-tag">${M.util.get_string('inprogress', 'local_edwiserreports')}</span>`
        ];
        PROMISE.GET_DATA(filter)
            .done(function(response) {
                ...
                dataTable = $(SELECTOR.TABLE).DataTable({
                    ...
                    deferRendering: true,
                    columnDefs: [
                        { className: "fixed-column", targets: [0, 1, 2, 3, 4, 5, 6, 7] },
	...
	console.log('CALLING ON INIT initializeDatatable ::: ');
