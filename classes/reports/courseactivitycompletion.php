...
class courseactivitycompletion extends base {
    ...
    public function get_data($filters, $table = true) {
        ...
        $response = array(
          array(
            ...
            'status' => 1,
            'completedon' => $rtl ? '<label style="direction:ltr;">2022 Nov 21</label>' : '21 Nov 2022',
            'grade' => '300',
            'gradedon' => $rtl ? '<label style="direction:ltr;">2022 Nov 1</label>' : '1 Nov 2022',
            'firstaccess' => $rtl ? '<label style="direction:ltr;">2022 Sept 1 <br>AM 39:09 </label>' : '1 Sept 2022 <br> 09:39 AM',
            'lastaccess' => $rtl ? '<label style="direction:ltr;">2022 Nov 21 <br> AM 39:09</label>' : '21 Nov 2022 <br> 09:39 AM',
            'visits' => 300,
            'timespent' => '02:10:59'
          ),
          array(
    ...
    public function get_summary_data($filters) {
        ...
        $customheader = '<div>
            ...
            <div class="summary-card-title fw-bold">
                Announcement
            </div>
        </div>';
